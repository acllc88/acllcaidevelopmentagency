...
/* ═══════════════════════════════════════════════════════════════
   FIVERR GIG IMAGE COMPONENT — 1200x630 (1.91:1 aspect ratio)
   Bold, click-grabbing design for high conversions
   ═══════════════════════════════════════════════════════════════ */
function FiverrGigImage() {
  const gigRef = useRef<HTMLDivElement>(null);
  const [isDownloading, setIsDownloading] = useState(false);

  const handleDownload = async () => {
    if (!gigRef.current || isDownloading) return;
    setIsDownloading(true);
    try {
      await new Promise(r => setTimeout(r, 500));
      const canvas = await html2canvas(gigRef.current, {
        scale: 2,
        useCORS: true,
        allowTaint: true,
      ...
      link.download = 'Fiverr_Gig_AI_Developer.png';
    ...
    <div className="bg-slate-950 py-16 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-10">
          <span className="text-fuchsia-400 text-sm font-bold tracking-widest uppercase">Fiverr Gig Image</span>
          <h2 className="text-3xl md:text-4xl font-black mt-3 mb-4 text-white">Your Click-Grabbing Gig Thumbnail</h2>
          <p className="text-slate-400 text-lg max-w-2xl mx-auto">1200×630 pixels (1.91:1 aspect ratio) — optimized for Fiverr, LinkedIn, and OG images.</p>
          <button
            onClick={handleDownload}
            disabled={isDownloading}
            className="mt-6 inline-flex items-center gap-2 bg-fuchsia-600 hover:bg-fuchsia-500 disabled:bg-fuchsia-800 text-white px-6 py-3 rounded-full font-semibold transition-all hover:scale-105 disabled:scale-100 cursor-pointer disabled:cursor-wait"
          >
            {isDownloading ? (
        ...
        <div className="relative overflow-hidden rounded-2xl border-2 border-fuchsia-500/30 shadow-2xl shadow-fuchsia-500/10">
          <div className="overflow-x-auto">
            {/* The actual 1200x630 gig image */}
            <div
              ref={gigRef}
              style={{
                width: 1200,
            ...
            >
              ...
              <div style={{
                position: 'absolute',
                inset: 0,
                background: 'linear-gradient(135deg, #0a0f1a 0%, #1a1033 40%, #0a1628 70%, #0d0d1a 100%)',
              }} />
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <h1 style={{
                    ...
                    <span style={{ color: '#ffffff' }}>I Will Build Your</span>
                    <br />
                    <span style={{
                  ...
                  <p style={{
                    ...
                    GPT-4, Claude, LangChain — SaaS, Chatbots, AI Agents & Mobile Apps built to scale
                  </p>
                  ...
                  <div style={{
                    ...
                    {[
                      { emoji: '🤖', label: 'AI Chatbots' },
                      { emoji: '⚡', label: 'AI Agents' },
                      { emoji: '🌐', label: 'SaaS Apps' },
                      ...
                      <div key={i} style={{
                        ...
                        <span style={{ color: '#e2e8f0', fontSize: 15, fontWeight: 600 }}>{item.label}</span>
                      </div>
                    ))}
                  </div>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <span style={{ color: '#fbbf24', fontSize: 18, fontWeight: 800 }}>5.0</span>
                  </div>
                  ...
                  <div style={{
                    ...
                    <span style={{ color: '#10b981', fontSize: 13, fontWeight: 700 }}>ONLINE</span>
                  </div>
                </div>
              </div>
              ...
              <div style={{
                ...
                right: 0,
                height: 60,
                background: 'linear-gradient(90deg, rgba(139,92,246,0.15), rgba(6,182,212,0.15), rgba(16,185,129,0.15))',
        ...
        <p className="text-center text-slate-500 text-sm mt-4">
          Actual size: 1200 × 630 pixels — scroll horizontally on mobile to see full image
        </p>
      </div>
    </div>
  );
